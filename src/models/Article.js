...
const articleSchema = new mongoose.Schema({
  ...
  title: {
    ...
    maxLength: [60, 'عنوان مقاله نمی‌تواند بیشتر از 60 کاراکتر باشد'],
    trim: true
  },
  minorCat: {
    type: String,
    required: [true, 'دسته‌بندی فرعی الزامی است'],
    minLength: [2, 'دسته‌بندی فرعی باید حداقل 2 کاراکتر باشد'],
  ...
  majorCat: {
    ...
    minLength: [2, 'دسته‌بندی اصلی باید حداقل 2 کاراکتر باشد'],
